...
function dataAnimate()
{
	$('[data-animate]').each(function(){
		...
		if(!$toAnimateElement.hasClass('animated'))
		{
			...
			{
			setTimeout(function(){$toAnimateElement.removeClass('not-animated').addClass(elementAnimation+' animated')},toAnimateDelayTime)
			},
			{accX:0,accY:-parseInt(70/1920*$(window).width())},
			'easeInCubic'
			)}})
		}