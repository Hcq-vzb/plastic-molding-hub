...
$(function () {
	...
	$(".claksi_top_left_2 #submit").click(function() {
		var txt_1 = $("#txt_name");
		if ($.trim(txt_1.val()) == "") {
			layer.tips('请输入姓名!', '#txt_name', {time:2000,tips:[3,"#008cd6"]})
			txt_1.focus();
			return false;
		}
		var txt_3 = $("#txt_tel");
		if ($.trim(txt_3.val()) == "") {
			layer.tips('请输入联系方式!', '#txt_tel', {time:2000,tips:[3,"#008cd6"]})
			txt_3.focus();
			return false;
		}
		var txt_6 = $("#txt_title");
		if ($.trim(txt_6.val()) == "") {
			layer.tips('请输入所在地区!', '#txt_title', {time:2000,tips:[3,"#008cd6"]})
			txt_6.focus();
			return false;
		}
		...
		if ($.trim(txt_4.val()) == "") {
			layer.tips('请输入留言内容!', '#txt_content', {time:2000,tips:[3,"#008cd6"]})
			txt_4.focus();
			return false;
		}
		return true;
	...
	$(".seay input").click(function(){
		if($(".seaz input").val()==""){
			layer.tips('请输入内容!', '.seaz input', {time:2000,tips:[3,"#008cd6"]})
			return false;
		}
	})
